...
const API_URL = "https://sews3-1.onrender.com";
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      setMensaje({
        texto:
          'Solo se permiten correos @epn.edu.ec',
        tipo: 'error',
      });
    ...
    if (role === 'emprendedor') {
      ...
      if (!phoneRegex.test(data.phone)) {
        setMensaje({
          texto:
            'El celular debe tener 10 dígitos y empezar con 0',
          tipo: 'error',
        });
        ...
        >
          ...
          <div className="flex flex-col items-center mb-2">
            ...
            <p className="text-sm text-gray-500 text-center mt-2">
              Plataforma de emprendimientos EPN
            </p>
          </div>
          ...
          {mensaje.texto && (
            <div
              className={`border-l-4 p-3 rounded-xl text-sm font-medium ${
                mensaje.tipo === 'error'
          ...
          <button
            type="submit"
            className="bg-[#00665c] hover:bg-[#004d45] text-white py-3 rounded-xl font-semibold transition"
          >
            Registrarse
          </button>
        ...
        <div className="max-w-lg">
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-10 backdrop-blur-sm">
            ...
            <p className="text-white/70 text-lg leading-relaxed">
              Sistema web para impulsar
              los emprendimientos y talentos
